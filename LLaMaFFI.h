...
struct llama_context_params {
    ...
    float tensor_split[1]; // how to split layers across multiple GPUs
...
typedef struct _llama_session_file_header {
	uint32_t magic ;
	uint32_t version ;
	_llama_hparams model_hparams;
	uint32_t n_tokens_count;
} _llama_session_file_header ;
